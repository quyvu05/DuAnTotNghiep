...
namespace Shop.Module.Catalog.Controllers
{
    ...
    public class RecentlyViewedApiController : ControllerBase
    {
        ...
        /// </summary>
        /// <param name="take">The number of records returned, default is 20.</param>
        ...
        /// <summary>
        /// Clears all recent browsing history for the user.
        /// </summary>
        ...
        /// <summary>
        /// Removes the specified item from the user's recent browsing history.
        /// </summary>
