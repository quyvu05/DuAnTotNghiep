...
namespace Shop.Module.Catalog.Controllers
{
	...
	public class CategoryApiController : ControllerBase
	{
		...
		/// <summary>
		/// Get the information of all product categories.
		/// </summary>
		/// <returns> Returns the information list of all product categories. </returns>
		[HttpGet]
		...
		public async Task<Result> Delete(int id)
		{
			...
			{
				return Result.Fail("Please make sure this category does not contain subcategories");
			}
