...
{
    /// <summary>
    /// The management backend controller is used to handle API requests for widget product related operations.
    /// </summary>
    ...
    public class WidgetProductApiController : ControllerBase
    {
        ...
        /// <summary>
        /// Gets widget product information based on the specified widget instance ID.
        /// </summary>
        ...
        /// </summary>
        /// <param name="model">The widget product parameters to create.</param>
        /// <returns>Indicates the result of the operation<see cref="Result"/> Object.</returns>
        [HttpPost]
        ...
        /// <summary>
        /// Updates the product information of the widget with the specified ID.
        /// </summary>
        /// <param name="id">Widget instance ID.</param>
