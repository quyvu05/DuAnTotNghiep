...
namespace Shop.Module.Catalog.Controllers
{
    ...
    public class UnitApiController : ControllerBase
    {
        ...
        /// Create a new unit.
        /// </summary>
        /// <param name="model">A parameter object containing the unit name.</param>
        ...
        /// <param name="model">A parameter object containing the new unit name.</param>
        /// <returns>Operation result.</returns>
        ...
        /// <returns>Operation result: If the unit is already in use, deletion is not allowed.</returns>
        ...
        /// <summary>
        /// Clears the cache of all unit information.
        /// </summary>
        /// <returns>Operation result.</returns>
