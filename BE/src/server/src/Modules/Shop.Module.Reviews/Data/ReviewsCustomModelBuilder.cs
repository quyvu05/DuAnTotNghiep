    ...
    public class ReviewsCustomModelBuilder : ICustomModelBuilder
    {
        public void Build(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AppSetting>().HasData(
                new AppSetting(ReviewKeys.IsReviewAutoApproved) { Module = module, IsVisibleInCommonSettingPage = true, Value = "false", Type = typeof(bool).FullName, Note = "Enable automatic review approval feature" },
                new AppSetting(ReviewKeys.IsReplyAutoApproved) { Module = module, IsVisibleInCommonSettingPage = true, Value = "true", Type = typeof(bool).FullName, Note = "Enable automatic reply approval feature" }
                );
        }
    }
}
