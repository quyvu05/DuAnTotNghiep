...
{
	/// <summary>
	/// Defines the service interface for handling commodity classification related operations.
	/// </summary>
	public interface ICategoryService
	{
		...
		/// <param name="all">A list of all available categories. </param>
		...
		/// </summary>
		/// <param name="parentId">The ID of the parent category. If it is null, get the top-level category and its sub-categories. </param>
